...
<script type="text/javascript">
	$(document).ready(function (e) {
		$("#form").on('submit',(function(e) {
			...
			var fileName2 = document.getElementById('validation_doc').value;
			...
			var ajaxRequest;  // The variable that makes Ajax possible!
				 ...
				 var queryString = "Username="+Username+"&table=contributor";
			...
			{
			    flag2=1;
			    var divVar2 = document.getElementById('show_result2');
				divVar2.innerHTML = "";
			}
			else
			{
				var divVar2 = document.getElementById('show_result2');
				divVar2.innerHTML = "Upload pdf format documents only";
			}
			if(flag1==1 && flag2==1){
				if(flag0==1){
					return true;
...
<script language="javascript" type="text/javascript">
   ...
   <div id="header_part">
	...
	<div class="container" style="min-height:900px;">
		<h2 id="registration" class="page-header">Contributor Registration:<small><a href="reviewerReg.php">(Reviewer registration)</a></small></h2>
		<div id="formArea" style="width:600px;min-height:900px;">
			<form id="form" action="contributorReg2.php" method="post" enctype="multipart/form-data" role="form" >
				...
				<div id="show_result2" style="height:30px;color:#FF0000; text-align: center;">
				</div>
				<div class="form-group">
					<label>Upload validation document:</label>
					<span class="help-block">Choose your validation document ...</span>
					<input type="file" name="validation_doc" id="validation_doc" required autofocus>
				</div>
