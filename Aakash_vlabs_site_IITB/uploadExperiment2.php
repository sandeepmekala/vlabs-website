...
<head>
  ...
  <script type="text/javascript">
	...
	function ajaxFunction(){
		...
		var queryString = "name=" + name +"&subject_name=" + subject_name + "&class_no=" + class_no + "&description=" + description+ "&theory=" + theory+ "&proc=" + proc+ "&video=" + video+ "&simulation=" + simulation+ "&quiz=" + quiz+ "&resource=" + resource+ "&icon=" + icon+ "&Username=" + Username;
		//alert(queryString);
		
		ajaxRequest.open("POST", "generateHTMLS2.php", true);
	...
	<div class="container" style="width:900px;min-height:1500px;">	
		<div id="formArea" style="min-height:1000px;">
			<form id="form" method="post" enctype="multipart/form-data" role="form"">
				...
				<div class="form-group">
					<label >Enter url for Simulation:</label>
				...
				<div class="form-group">
					...
					<span class="help-block">You can simply copy and paste in editor it takes care os tables and images...</span>
					<input type="url" class="form-control" id="quiz" placeholder="Enter url..." required autofocus>
				</div>
