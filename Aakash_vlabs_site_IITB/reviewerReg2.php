...
<body onload="updateSignIn()">
	...
	$query1 = "INSERT INTO reviewer (Username, Password, first_name, last_name,email,contact,picture,specialized_subject) VALUES ('$Username','$Password','$first_name','$last_name','$email','$contact','assets/img/user_pictures/$picture','$specialized_subject')";
