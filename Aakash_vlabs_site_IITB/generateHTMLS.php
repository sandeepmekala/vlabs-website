...
$uploaded_date = mysql_real_escape_string($uploaded_date);
...
$query2 = "INSERT INTO experiment_details (class_no, subject_name, exp_no, name,description,theory,proc,video,simulation,quiz,resource,contributor,uploaded_date,status,reviewer,review_date,icon) VALUES ('$class_no','$subject_name','$exp_no','$name','$description','assets/theory/$name.html','assets/proc/$name.html','$video','$simulation','$quiz','assets/resource/$name.html','$Username',$uploaded_date,'0','','0000-00-00','$icon')";
